...
def find_difference(image1, image2):
    ...
    difference1 = difference_image - np.min(difference_image)
    difference2 = np.max(difference_image) - np.min(difference_image)
    normalized_difference_image = difference1 / difference2
